...
Durante la sesión de clase, el equipo trabajó en el análisis y modelado del proceso de agendamiento de citas médicas correspondiente al caso base de la Clínica Salud Viva.
...
Se elaboró un boceto inicial en papel durante la sesión y posteriormente se digitalizó en draw.io, representando el flujo desde el ingreso del paciente al sistema hasta la confirmación o rechazo de la cita según disponibilidad.

## 🔁 Tareas definidas para complementar el taller

| Tarea asignada | Responsable | Fecha estimada |
|----------------|-------------|----------------|
| Ajuste del modelo BPMN del caso base | Isabela Díaz Acosta | 7/02/2026 |
...
*Este documento resume el trabajo colaborativo realizado durante la sesión del Taller 1 en el curso AREM - Universidad de La Sabana.*
